...
function createHover(snipet){
    ...
    return new vscode.Hover({ language: "tpl", value: description + "\n\n" + example });
}

function activate(context) {

    var hovers = vscode.languages.registerHoverProvider('tpl', {
    ...
    var filters = vscode.languages.registerCompletionItemProvider('tpl',{
    ...
    var loopField = vscode.languages.registerCompletionItemProvider('tpl',{
    ...
    var tests = vscode.languages.registerCompletionItemProvider('tpl',{
